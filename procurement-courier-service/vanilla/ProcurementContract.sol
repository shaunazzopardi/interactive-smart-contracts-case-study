contract Procurement {
    ...
    function Procurement(
        address _seller, address _buyer, address _courier,
    ...
    ) public payable byBuyer
    {
        ...
        courier.call(bytes4(keccak256("addOrder(address, uint, uint")), address(this), _orderNumber, now+_orderDeliveryTimeLeft);
    }
